...
def fetch_freshwater_withdrawal(cache_path, country="WLD", start_year=1960, end_year=2022, refresh=False):
    """Obtiene Annual freshwater withdrawals, total (% of internal resources) del World Bank."""
