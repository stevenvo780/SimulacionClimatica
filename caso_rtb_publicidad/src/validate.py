"""
validate.py — RTB Publicidad Programática
...
from data import fetch_rtb_monthly
...
def load_real_data(start_date, end_date):
    ...
    cache_path = os.path.join(os.path.dirname(__file__), "..", "data", "rtb.csv")
    df = fetch_rtb_monthly(start_date, end_date, cache_path=os.path.abspath(cache_path))
...
def main():
    config = CaseConfig(
        case_name="RTB Publicidad Programática",
        value_col="value",
