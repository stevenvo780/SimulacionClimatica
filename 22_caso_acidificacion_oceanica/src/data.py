...
def fetch_co2_per_capita(cache_path, country="WLD", start_year=1960, end_year=2022, refresh=False):
    """Obtiene CO2 emissions per capita (proxy acidificación) del World Bank."""
