"""
validate.py — Estética (MoMA Paradigmas)
...
def main():
    config = CaseConfig(
        case_name="Estética (MoMA Paradigmas)",
        value_col="value",
        series_key="incidence",
        grid_size=20,
        persistence_window=10,
        synthetic_start="1929-01-01",
        synthetic_end="2023-01-01",
        synthetic_split="1980-01-01",
        real_start="1929-01-01",
        real_end="2023-01-01",
        real_split="1980-01-01",
        corr_threshold=0.7,
        extra_base_params={},
    )
