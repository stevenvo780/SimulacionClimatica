"""
validate.py — Moderación Adversarial
...
def load_real_data(start_date, end_date):
    ...
    cache_path = os.path.join(os.path.dirname(__file__), "..", "data", "moderation.csv")
    df = fetch_moderation_monthly(start_date, end_date, cache_path=os.path.abspath(cache_path))
...
def main():
    config = CaseConfig(
        case_name="Moderación Adversarial",
        value_col="value",
