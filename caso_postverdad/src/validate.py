"""
validate.py — Postverdad (Fake News)
...
def load_real_data(start_date, end_date):
    ...
    cache_path = os.path.join(os.path.dirname(__file__), "..", "data", "posttruth.csv")
    df = fetch_posttruth_monthly(start_date, end_date, cache_path=os.path.abspath(cache_path))
